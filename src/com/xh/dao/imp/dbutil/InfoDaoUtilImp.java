...
public class InfoDaoUtilImp extends BaseDao implements InfoDao {
	...
	public boolean addInfo(Info info) {
		...
		try {
			...
			System.out.println("通过DbUtil添加Info出现异常");
			e.printStackTrace();
		}
	...
	public boolean deleteInfo(int id) {
		...
		try {
			...
			System.out.println("通过DbUtil删除Info出现异常");
			e.printStackTrace();
		}
		return BaseDao.isTrue(i);
	}
	...
	public boolean updateInfo(Info info) {
		...
		try {
			...
			System.out.println("通过DbUtil机制来修改Info出现异常");
			e.printStackTrace();
		}
		return BaseDao.isTrue(i);
	}
	...
	public boolean checkInfo(int id) {
		...
		try {
			...
			System.out.println("通过DbUtil机制来审核Info出现异常");
			e.printStackTrace();
		}
		return BaseDao.isTrue(i);
	}
	...
	public boolean hasInfo(Date date, int userId)
	{
		...
		try {
			...
			System.out.println("通过DbUtil机制来检测时候有Info安排出现异常");
			e.printStackTrace();
		}
		if(list.size()>0)
			return true;
	...
	public Info getInfo(int id) {
		...
		try {
			...
			System.out.println("通过DbUtil机制来获取Info出现异常");
			e.printStackTrace();
		}
		return info;
	}
	...
	public List<Info> getAllInfo() {
		...
		try {
			...
			System.out.println("通过DbUtil机制来获取所有的Info出现异常");
			e.printStackTrace();
		}
		return list;
	}
